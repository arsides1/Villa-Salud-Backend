...
import com.villasalud.dto.NombreRequest;
import com.villasalud.model.Menu;
import com.villasalud.service.IMenuService;
...
public class MenuController {
	...
	@PostMapping(value = "/usuario", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<Menu>> listar(@RequestBody NombreRequest nombreRequest) {
		String nombre = nombreRequest.getNombre();
		List<Menu> menus = new ArrayList<>();
		menus = service.listarMenuPorUsuario(nombre);
		return new ResponseEntity<List<Menu>>(menus, HttpStatus.OK);
	}
